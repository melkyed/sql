...
VALUES
    (10, 'Thomass Superfood Store', 'Fresh Focused store', 'Thomas Rosenthal', 'Superfood specialty');
...
SELECT
    customer_id,
    -- %m modifier returns the month as a two-digit number (01-12)
    strftime('%m', market_date) AS purchase_month,
    -- %Y modifier returns the year as a four-digit number (YYYY)
